 ...
 */
let walkingChallenges: [String] = ["Walk 3 miles a day", "Walk 10 miles in 10 days"]
let runningChallenges: [String] = ["Run 3 miles a day", "Run 10 miles in 10 days"]
...
let committedChallenges: [String] = ["Run 5 times a week", "Eat healthy"]
